...
public class Field : MonoBehaviour
{
    ...
    void CreateField()
    {
        ...
        float starX = -(fieldWidth / 2) + (CellSize / 2) + Spacing;
        float starY = (fieldWidth / 2) - (CellSize / 2) - Spacing;
        ...
        for (int x = 0; x < FieldSize; x++)
        {
         for (int y = 0; y < FieldSize; y++)
         {
            ...
            var position = new Vector2(starX + (x *(CellSize + Spacing)), starY - (y *(CellSize + Spacing)));
